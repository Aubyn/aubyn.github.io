import{l as a,c as i,b as n,ai as l}from"./chunks/framework.DfOqixww.js";const o=JSON.parse('{"title":"alpine","description":"","frontmatter":{},"headers":[],"relativePath":"blog/cheetsheet/alpine.md","filePath":"blog/cheetsheet/alpine.md","lastUpdated":1746851574000}'),e={name:"blog/cheetsheet/alpine.md"};function p(t,s,h,k,d,r){return n(),i("div",null,s[0]||(s[0]=[l(`<h1 id="alpine" tabindex="-1">alpine <a class="header-anchor" href="#alpine" aria-label="Permalink to &quot;alpine&quot;">​</a></h1><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 查看已安装的软件包</span></span>

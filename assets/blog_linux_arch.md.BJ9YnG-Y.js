...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 添加新用户,重要</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> vim</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /etc/sudoers</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 添加，确保用户能使用 sudo 提权</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">\${user} ALL</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">ALL:ALL</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) ALL</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 可开启 %wheel ALL=(ALL:ALL) NOPASSWD: ALL</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 添加源，建议添加便于安装 paru</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 先配置好 rime 配置文件，如果不生效，需要参考《rime》文章中的脚本，重新加载</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">proxychains</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> \${command}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 蓝牙，或需要通过 rfkill list 来检查软硬件锁</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> pacman</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -S</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> bluez</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> bluez-utils</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> blueman</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> systemctl</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> enable</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> bluebooth</span></span></code></pre></div><h2 id="参考" tabindex="-1">参考 <a class="header-anchor" href="#参考" aria-label="Permalink to &quot;参考&quot;">​</a></h2><ul><li><a href="https://arch.icekylin.online/guide/" target="_blank" rel="noreferrer">archlinux 简明指南</a></li><li><a href="https://blog.csdn.net/orangebench11/article/details/139381701" target="_blank" rel="noreferrer">安装 Arch Linux 和 KDE Plasma 6 &amp; 配置 fcitx5-rime 输入法 | 轻度美化 | 双系统/虚拟机 （2024.6.1）</a>，wayland 新版本参考</li><li><a href="https://www.zzxworld.com/posts/install_archlinux_on_intel_nuc_notes" target="_blank" rel="noreferrer">Intel NUC 安装 Arch Linux 历险记</a>，x11 旧版本参考</li><li><a href="https://senzyo.net/2023-3/" target="_blank" rel="noreferrer">Arch安装|Senzyo</a>，X11 旧版本参考，推荐</li><li><a href="https://blog.azurezeng.com/timeline/" target="_blank" rel="noreferrer">Azure Zeng Blog</a>，arch 安装非常详细，用户组与权限，音频驱动，kde 软件包精简安装</li><li><a href="https://bersella-ai.cc/LivingWithArchLinux2" target="_blank" rel="noreferrer">和 Arch Linux 打交道其二：又一次大动干戈</a>，arch，kde 精简安装</li><li><a href="http://anclark.github.io/2020/02/14/Struggle_with_Linux/Arch%20Linux%E4%B8%8EKDE%E5%AE%89%E8%A3%85%E8%BF%87%E7%A8%8B/" target="_blank" rel="noreferrer">Arch Linux + KDE安装教程</a>，arch，kde 精简安装，声音驱动详解</li><li><a href="https://krau.top/posts/archlinux-on-y9kp22-1" target="_blank" rel="noreferrer">ArchLinux on Y9000P2022十分好用,就是有点难用</a>，arch，多显示器，蓝牙耳机</li><li><a href="https://kkocdko.site/post/202208221154" target="_blank" rel="noreferrer">简陋的 Win on Linux 兼容方案</a>，win on linux，kvm，博客体积压缩</li><li><a href="https://szclsya.me/zh-cn/posts/fonts/linux-config-guide/" target="_blank" rel="noreferrer">Linux 下的字体调校指南</a></li><li><a href="https://xland.cyou/p/arch-linux-configuration-btrfs-and-system-backup/" target="_blank" rel="noreferrer">Arch Linux 配置 — Btrfs与系统备份</a></li><li><a href="https://sspai.com/post/78916" target="_blank" rel="noreferrer">现代化的 Archlinux 安装，Btrfs、快照、休眠以及更多。 - 少数派</a></li></ul>`,33)]))}const c=i(h,[["render",p]]);export{g as __pageData,c as default};
